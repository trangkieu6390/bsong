...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li class="active"><a href="<%=request.getContextPath()%>/public/trang-chu"><span>Trang chủ</span></a>
          <li><a href="<%=request.getContextPath()%>/public/lien-he"><span>Liên hệ</span></a></li>
        </ul>
      </div>
      <div class="clr"></div>
      <div class="slider">
